...
class AppConfig {
  ...
  static const String appDescription =
      'Advanced E-Learning Platform with VR/AR and AI';
  ...
  static const int liteModeThrsholdKbps = 1000; // 1 Mbps
...
class PlatformConfig {
  ...
  static bool get supportsVR => Platform.isAndroid || isDesktop;

  static bool get supportsAR => Platform.isIOS || Platform.isAndroid;

  static bool get supportsWebRTC => !isWeb || (isWeb && !isMobile);
}
