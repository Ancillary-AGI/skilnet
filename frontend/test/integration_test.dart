...
// import 'package:patrol/patrol.dart'; // Commented out until patrol is properly configured
...
void main() {
  ...
  group('EduVerse Integration Tests', () {
    testWidgets('Complete user onboarding and login flow', (WidgetTester tester) async {
      ...
      expect(find.text('Immersive Learning'), findsOneWidget);
      expect(find.text('AI-Powered Teaching'), findsOneWidget);
      ...
      await tester.enterText(find.text('Username'), 'testuser');
      await tester.enterText(find.text('Password'), 'securepassword123');
      await tester.enterText(find.text('First Name'), 'Test');
      await tester.enterText(find.text('Last Name'), 'User');
    ...
    testWidgets('Course browsing and enrollment flow', (WidgetTester tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: app.EduVerseApp(),
        ),
      ...
      // Start with authenticated user - skip login for now
      ...
      // Search for a course
      await tester.enterText(find.text('Search courses'), 'machine learning');
      await tester.pumpAndSettle();
    ...
    // Temporarily commented out all remaining patrol tests until patrol is properly configured
    // All tests have been converted to standard testWidgets above
    /*
    patrolTest('Complete user onboarding and login flow',
        (PatrolTester $) async {
      // Start the app
    ...
    patrolTest('AI tutor interaction', (PatrolTester $) async {
      ...
      await $.enterText(
          $('Type your question'), 'Show me a diagram of neural networks');
      await $.tap($('Send'));
      await $.pumpAndSettle();
...
Future<void> _loginTestUser(WidgetTester tester) async {
  ...
  // Login
  await tester.enterText(find.text('Email'), 'test@example.com');
  await tester.enterText(find.text('Password'), 'testpassword123');
  await tester.tap(find.text('Sign In'));
  await tester.pumpAndSettle();
}
